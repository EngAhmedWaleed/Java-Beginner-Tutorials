		...
		moveButton.addActionListener(
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent event) {
						/*
						 * deprecated: getselectedvalues check
						 * https://stackoverflow.com/questions/7461940/java-deprecated-method-what-to-do
						 * rightList.setListData((String[]) leftList.getSelectedValuesList().toArray());
						 * well it didn't work ...
						 */

						/*
						 * my awesome HABDA https://www.java-samples.com/showtutorial.php?tutorialid=219
						 * https://www.techiedelight.com/convert-char-array-string-java/
						 */

						String[] selectedFoods = leftList.getSelectedValuesList().toString()
								.split(", "); /* toString converts the list to: [0, 1, 2 ...] */
						...
						selectedFoods[selectedFoods.length - 1].getChars(0,
								selectedFoods[selectedFoods.length - 1].length() - 1, tar2e3Agmad, 0);
						selectedFoods[selectedFoods.length - 1] = new String(tar2e3Agmad);

						// JOptionPane.showMessageDialog(null, selectedFoods, "title",
						// JOptionPane.PLAIN_MESSAGE); debugging purpose
