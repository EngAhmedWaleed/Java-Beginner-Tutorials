...
public class JComboBoxProgram extends JFrame {
	 ...
	 * parameterized JComboBox<String> box; will get the job done As of Java 7,
	 * generics were introduced into JComboBox component
	 */
	...
	// note that getClass is non static method, thats why we didn't declare a
	// private static Icon
