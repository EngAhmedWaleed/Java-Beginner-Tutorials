		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				try {
					...
					JOptionPane.showMessageDialog(Lesson23.this, "Please Enter the Right Info", "Error",
				...
				if (dollarSign.isSelected()) {
					...
					JOptionPane.showMessageDialog(Lesson23.this, numFormat.format(totalCalc), "Solution",
				...
				// If the comma is selected in the checkbox print the number with commas
					...
					JOptionPane.showMessageDialog(Lesson23.this, totalCalc, "Solution",
							JOptionPane.INFORMATION_MESSAGE);
