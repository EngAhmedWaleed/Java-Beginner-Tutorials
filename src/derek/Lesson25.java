...
public class Lesson25 extends JFrame {
	...
	public Lesson25() {
		 ...
		 * getSelectedIndexes(): returns every selection in a list getSelectedValue():
		 * returns the value of the first selected getSelectedValues(): returns an array
		 * of all values isSelectedIndex(): returns true if index is selected
		 */
	...
	private class ListenForButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				JOptionPane.showMessageDialog(Lesson25.this, infoOnComponent, "Information",
